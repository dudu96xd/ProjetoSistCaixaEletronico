...
public class Conta extends Cliente {
	...
	private void salvarTransferencia(int valorATransferir, int ContaATransferir, ContaTO to) throws IOException {
        ...
        String linhaBR = "<tr><td width='10%'>"+dataBR+"</td><td width='75%'>Transferência para a Agência "+Conta[0]+" - Conta "+Conta[1]+"</td><td width='15%'> <p class='verm'>"+valorATransferir+",00-</p></td></tr>";
        String linhaUS = "<tr><td width='10%'>"+dataUS+"</td><td width='75%'>Transfer to the Agency "+Conta[0]+" - Account "+Conta[1]+"</td><td width='15%'> <p class='verm'>"+valorATransferir+",00-</p></td></tr>";
        String linhaES = "<tr><td width='10%'>"+dataES+"</td><td width='75%'>Transferencia para la Agencia "+Conta[0]+" - Cuenta "+Conta[1]+"</td><td width='15%'><p class='verm'>"+valorATransferir+",00-</p></td></tr>";
        ...
        linhaBR = "<tr><td width='10%'>"+dataBR+"</td><td width='75%'>Recebeu da Agência "+agencia+" - Conta "+conta+"</td><td width='15%'> "+valorATransferir+",00</td></tr> ;"+ContaATransferir;
        linhaUS = "<tr><td width='10%'>"+dataUS+"</td><td width='75%'>Received of the Agency "+agencia+" - Account "+conta+"</td><td width='15%'> "+valorATransferir+",00</td></tr> ;"+ContaATransferir;
        linhaES = "<tr><td width='10%'>"+dataES+"</td><td width='75%'>Recibió da Agencia "+agencia+" - Cuenta "+conta+"</td><td width='15%'> "+valorATransferir+",00</td></tr> ;"+ContaATransferir;
